...
class Agua extends CI_Controller{

    private $data;
    
    public function __construct() {
        parent::__construct();
        $this->load->model('agua_model');
    ...
    public function index() {
        ...
        $resp = $this->agua_model->inicioSession();
        ...
        if ($resp['estatus']=='1') {
            $data['vista'] = $this->load->view('agua/index.php',$data, TRUE); //True para pasar la vista como dato
    ...
    public function buscarAgua(){
            ...
            $NexTer = $this->input->post('NexTer') != "" ? $this->input->post('NexTer') : "S/N";   
           ...
           if($pagina != 'Datos') 
            ...
            else
            {
                ...
                $this->form_validation->set_rules('NumeroContrato', 'Número de Contrato', 'required|trim');
                $this->form_validation->set_rules('NexTer', 'Número Exterior', 'trim');
